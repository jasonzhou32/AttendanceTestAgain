<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <div class="sidebar-heading">Classes</div>
    <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="createClass.php">Create/Delete Classes</a>
            </div>
        </div>
    </li>
     <!-- <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="createClassTeacher.php">Create/Delete Teachers</a>
            </div>
        </div>
    </li>
     <!-- <li class="nav-item">
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="createStudents.php">Create/Delete Students</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Manage Volunteers</h6>
                 <a class="collapse-item" href="createVolunteers.php">Create/Delete Volunteers</a>
